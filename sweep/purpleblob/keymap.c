...
//Punc Layer
    [1] = LAYOUT(
        ...
        KC_NUHS,  KC_EXLM, S(KC_NUBS), KC_AMPR, KC_PERC, KC_CIRC, KC_DLR,  KC_ASTR, KC_LT, KC_GT,
                                   KC_TRNS, KC_TRNS, KC_TRNS, KC_COLN
    ),
...
//KC_AT (KC_DQT), KC_INS, KC_DEL
        ...
        S(KC_NUHS), KC_PGDN, KC_PGUP, KC_HOME, KC_INS, KC_DEL, KC_END,  _______, _______, KC_NUBS,
...
//Gaming Upper Layer
    [5] = LAYOUT(
        ...
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        KC_TAB,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,  KC_RBRC, KC_RPRN, KC_RCBR, KC_QUOT, KC_SCLN,
        KC_LALT, KC_T, KC_G, KC_V, _______, KC_CIRC, KC_DLR,  KC_ASTR, KC_NUBS, KC_SLSH,
                                   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
